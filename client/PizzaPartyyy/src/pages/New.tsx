...
function New() {
    ...
    const createPizza = async (event: FormEvent<HTMLFormElement>) => {
        ...
        let response
        try {
            response = await fetch('http://localhost:3001/pizzas', options)
        } catch {
        ...
        setError(result.error || 'Pizza could not be created.')
    }
    ...
    return (
        <div className="min-h-screen bg-slate-100 p-8">
            <div className="mx-auto max-w-xl rounded-md bg-white p-6 shadow">
                <h1 className="mb-4 text-2xl font-bold">Create Pizza</h1>
                ...
                <form onSubmit={createPizza} className="space-y-5">
                    <div>
                    ...
                    <fieldset className="rounded-md border border-slate-300 p-4">
                        ...
                        <label className="mr-4">
                            <input
                                ...
                                name="topping"
                                value="meat-lover"
                                checked={pizza.topping === 'meat-lover'}
                                onChange={handleChange}
                                required
                            />
                        ...
                        <label>
                            <input
                                ...
                                name="topping"
                                value="vegetarian"
                                checked={pizza.topping === 'vegetarian'}
                                onChange={handleChange}
                            />
